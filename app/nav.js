  ...
  return (
    <div className="min-h-screen bg-gray-100 flex flex-col">
      ...
      <div className="flex-1 overflow-auto p-4">
        ...
        <div className="flex justify-start mb-2">
          <div className="bg-stone-100	  text-black p-3 rounded-tr-3xl rounded-br-3xl rounded-bl-3xl max-w-xs">
        ...
        <div className="flex justify-start mb-2">
          <div className="bg-stone-200		 text-black p-3 rounded-tr-3xl rounded-br-3xl rounded-bl-3xl max-w-xs">
