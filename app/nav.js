    ...
    <div className="min-h-screen bg-gray-100 flex flex-col">
      ...
      <div className="flex-1 overflow-auto p-4">
        ...
        <div className="flex justify-end mb-2">
          <div className="bg-fuchsia-100  text-black p-3 rounded-tl-3xl rounded-bl-3xl rounded-br-3xl max-w-xs">
        ...
        <div className="flex justify-end mb-2">
          <div className="bg-cyan-100 text-black p-3 rounded-tl-3xl rounded-bl-3xl rounded-br-3xl max-w-xs">
        ...
        <div className="flex justify-end mb-2">
          <div className="bg-purple-100 text-black p-3 rounded-tl-3xl rounded-bl-3xl rounded-br-3xl max-w-xs">
